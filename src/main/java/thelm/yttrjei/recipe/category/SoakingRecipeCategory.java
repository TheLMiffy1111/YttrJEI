...
public class SoakingRecipeCategory extends AbstractRecipeCategory<SoakingRecipe> {
	...
	public static final Text TITLE = new TranslatableText("emi.category.yttr.soaking");
	public static final Text CONSUME_HINT = new TranslatableText("emi.category.yttr.soaking.consumes_catalyst");

	public static final IDrawable ICON = new IngredientDrawable<>(new ItemStack(YItems.VOID_BUCKET));
	public static final IDrawable CURVED_ARROW_DOWN = new ResourceDrawable(Yttr.id("textures/gui/curved_arrow_down.png"), 0, 0, 16, 16, 16, 16);
